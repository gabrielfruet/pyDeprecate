...
class TestProxyAstFriendliness:
    ...
    def test_wrapped_points_to_source_on_class_proxy(self) -> None:
        ...
        """
        wrapped = DeprecatedColorEnum.__wrapped__
    ...
    def test_unwrap_reaches_source_on_class_proxy(self) -> None:
        ...
        """
        assert inspect.unwrap(DeprecatedColorEnum) is DeprecatedColorEnum.__wrapped__
    ...
    def test_signature_matches_source_on_class_proxy(self) -> None:
        ...
        """
        source = DeprecatedColorEnum.__wrapped__
        assert DeprecatedColorEnum.__signature__ == inspect.signature(source)
